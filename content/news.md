...
Sirovi dnevnik novih stvari koje Nemanja javi (najcesce preko Telegrama).
Iz ovoga nastaju postovi. Najnovije ide na vrh.

Format jednog unosa:

    ## 2026-09-19 · kratak naslov
    - sta se desilo, recima kako je Nemanja rekao
    - potvrdjeno: samo cinjenice koje je izricito rekao (brojke, mesta, rokovi)
    - nije potvrdjeno: sta se ne sme pisati u post dok ne potvrdi
    - materijal: link na Drive ili "nema"
    - status: novo | u draftu (<fajl>) | objavljeno (<tweet_id>)

Pravilo iz CLAUDE.md vazi i ovde: ne dodaji brojke, datume ni mesta koja
nisu izgovorena.
...
- Nemanja: sad je najvaznije da odrzimo kolonije jake i da prezime, jer ih koristimo kao bazu za kreiranje novih kolonija za HiveBits. Novi video na Drive-u, hoce da ga objavi danas.
- potvrdjeno: video je "samo jedan od nasih pcelinjaka" (ima ih vise, broj nije receno). Prioritet sada je da kolonije budu jake i prezime; od njih se prave nove kolonije za HiveBits.
...
- nije potvrdjeno: da li Nemanja i sam radi (ili samo snima), sta ce biti sa voskom, da li je vosak vezan za farmu, sta se tacno vidi na snimcima (video nije pregledan). Nista od toga ne ide u post dok ne potvrdi.
